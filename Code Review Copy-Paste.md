...
The normal text preview is for reference. For copy-paste purposes, triple-click the text block and copy the text; once you paste it on the site the markdown will be formatted correctly. If you have the auto comment script then you can alturnatly import all of these from [here](CodeReviewCopy-PasteRaw.md).
